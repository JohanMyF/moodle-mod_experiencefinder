...
$string['name'] = 'Name';
$string['shapeintro'] = 'SHAPE portfolio introduction';
$string['shapeintro_help'] = 'Teacher-defined text shown at the beginning of the final SHAPE Discovery Portfolio.';
...
$string['storedpromptinfo'] = 'Select any items that apply. These selections may appear in your SHAPE Discovery Portfolio.';
$string['shapeportfolio'] = 'My Unique SHAPE - Results and Profile';
...
$string['linkedactivities'] = 'Linked SHAPE activities';
...
$string['sectionresult'] = 'SHAPE result to display in this section';
$string['sectionresultnone'] = 'Do not display a linked SHAPE result in this section';
